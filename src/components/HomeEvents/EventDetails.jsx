    ...
    <Card className="w-full max-w-screen-md rounded-2xl my-4  overflow-hidden mx-auto transition-all duration-300 hover:shadow-xl bg-white/70 backdrop-blur-sm border border-white/40 shadow-lg">
      <CardBody className="p-0">
        <div className="flex flex-col md:flex-row">
          <div className="md:w-2/5 md:h-auto overflow-hidde">
            <img
              src={thumbnail_url}
              alt=""
          ...
          <div className="p-6 space-y-4 relative w-full md:w-3/5">
            ...
            <div className="relative z-10 space-y-3">
              ...
              <div className="flex justify-between items-start">
                <Typography
                  className="font-sans  text-start text-2xl text-gray-800 font-bold tracking-tight leading-tight flex-grow"
                  variant="h6"
                >
              ...
              <Typography
                variant="small"
                className="text-sm text-start text-gray-600 leading-relaxed tracking-normal"
              >
